...
function PDFProgramacao(a,b,c) {




  pdfMake.vfs = pdfFonts.pdfMake.vfs;
  const dados12 = b.map((cliente) => {
    return [
   
      { text: cliente.t0, fontSize: 5, margin: [0, 50, 0, 0], alignment: 'center' },
  ...
  const reportTitle = [
    ...
    },
    {
      table: {
        ...
        body: [
          [
            { text: 'Técnico:', style: 'tableHeader', fontSize: 8, margin: [15, 0, 0, 0] },
            
          ],
        ],
      },
      margin: [127.5, -63, 0, 0]// headerLineO
    },
    {
      table: {
        headerRows: 1,
      ...
      layout: 'noBorders',margin: [127.5, -60, 0, 0]// headerLineO
    },
    {
      table: {
        headerRows: 1,
        ...
        body: [
          [
            { text: 'Edição:', style: 'tableHeader', fontSize: 8, margin: [15, 0, 0, 0] },
          ],
        ],
      },
      margin: [127.5, -1, 0, 0]// headerLineO
    },
    {
      table: {
        headerRows: 1,
        ...
        body: [
          [
            { text: 'Entidade:', style: 'tableHeader', fontSize: 8, margin: [15, 0, 0, 0] },
          ],
        ],
      },
      margin: [197, -63, 0, 0]// headerLineO
    },
    {
      table: {
        headerRows: 1,
        ...
        body: [
          [
            { text: 'Data Registro:', style: 'tableHeader', fontSize: 8, margin: [15, 0, 0, 0] },
          ],
        ],
      },
      margin: [197, -1, 0, 0]// headerLineO
    },
    {
      table: {
        headerRows: 1,
      ...
      margin: [600.5, -63, 0, 0]// headerLineO
    },
    {
      table: {
        headerRows: 1,
        ...
        body: [
          [
            { text: 'Lote:', style: 'tableHeader', fontSize: 8, margin: [15, 0, 0, 0] },
          ],
        ],
      },
      margin: [600.5, -1, 0, 0]// headerLineO
    },
    {
      table: {
        headerRows: 1,
        ...
        body: [
          [
            //[{ text: '2.8346', style: 'tableHeader', fontSize: 10 }],
            [{
              text: 'País:', style: 'tableHeader', fontSize: 8, margin: [15, 0, 0, 0]
            }]
          ],
        ],
      },
      margin: [15, 17.5, 0, 0], //[left, top, right, bottom]
    },
    {
      table: {
        headerRows: 1,
        widths: [156.7],// largura
        heights: [12.5], //altura
        body: [
          [
            //[{ text: '2.8346', style: 'tableHeader', fontSize: 10 }],
            [{
              text: 'Tipo de Amostra:', style: 'tableHeader', fontSize: 8, margin: [15, 0, 0, 0]
            }]
          ],
        ],
      },
      margin: [127.5, -18.5, 0, 0], //[left, top, right, bottom]
    },
    {
      table: {
        headerRows: 1,
        ...
        body: [
          [
            //[{ text: '2.8346', style: 'tableHeader', fontSize: 10 }],
            [{
              text: 'Laboratório:', style: 'tableHeader', fontSize: 8, margin: [15, 0, 0, 0]
            }]
          ],
        ],
      },
      margin: [293, -18.5, 0, 0], //[left, top, right, bottom]
    },

  ];

  const dados = a.map((cliente) => {
    return [
   
      { text: '', fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
      { text: cliente.Amostra, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
      { text: '', fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
      { text: cliente.ProfundidadeInicial, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
      { text: cliente.ProfundidadeFinal, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
      { text: cliente.MassaVolumica, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
      { text: cliente.MassaVolumica, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
      { text: cliente.MassaVolumica, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
      { text: cliente.MassaVolumica, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
      { text: cliente.MassaVolumica, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
  ...
  const dados0 = b.map((cliente) => {
    return [
      { text: cliente.t0, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
    ]
  });
  const dados1 = b.map((cliente) => {
    return [
      { text: cliente.t1, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
    ]
  });
  const dados2 = b.map((cliente) => {
    return [
      { text: cliente.t2, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
    ]
  });
  const dados3 = b.map((cliente) => {
    return [
      { text: cliente.t3, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
    ]
  });
  const dados4 = b.map((cliente) => {
    return [
      { text: cliente.t4, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
    ]
  });
  const dados5 = b.map((cliente) => {
    return [
      { text: cliente.t5, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
    ]
  });
  const dados6 = b.map((cliente) => {
    return [
      { text: cliente.t6, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
    ]
  });
  const dados7 = b.map((cliente) => {
    return [
      { text: cliente.t7, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
    ]
  });
  const dados8 = b.map((cliente) => {
    return [
      { text: cliente.t8, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
    ]
  });
  const dados9 = b.map((cliente) => {
    return [
      { text: cliente.t9, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
    ]
  });
  const dados10 = b.map((cliente) => {
    return [
      { text: cliente.t10, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
    ]
  });
  const dados11 = b.map((cliente) => {
    return [
      { text: cliente.t11, fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
    ]
  });
  const dados22 = c.map((cliente) => {
    return [
   
      { text: cliente.obj, fontSize: 5, margin: [0, 50, 0, 0], alignment: 'center' },
  ...
  const details = [
    {
      table: {
        headerRows: 1,
        widths: [
          19.8, 34.5, 40, 28.6, 28, 34, 34, 34, 72, 19.5,
          19.5,
          19.5,
          19.5,
          19.5,
        ...
        body: [
          [
            { text: 'Ordem', style: 'tableHeader', fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
            { text: 'Amostra', style: 'tableHeader', fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
            { text: 'COORD.Z', style: 'tableHeader', fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
            { text: 'COORD.N', style: 'tableHeader', fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
            { text: 'COORD.E', style: 'tableHeader', fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
            { text: 'Descrição de campo', style: 'tableHeader', fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
            { text: 'Arq', style: 'tableHeader', fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
            { text: '', style: 'tableHeader', fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
            { text: '', style: 'tableHeader', fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
            ...dados0,
           ...dados1,
           ...dados2,
           ...
           ...dados10,
           ...dados11,
            { text: 'Previsão de \n entrega/Status', style: 'tableHeader', fontSize: 5, margin: [0, 0, 0, 0], alignment: 'center' },
          ],
